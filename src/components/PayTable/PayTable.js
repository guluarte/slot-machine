...
export const PayTable = ({ isWinningPayTableLine }) => (
  <span>
    <h3>Pay-Table</h3>
    <List className="{classes.root}">
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_CHERRYS_ON_TOP)
            ? "blink_me"
            : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_CHERRYS_ON_MIDDLE)
            ? "blink_me"
            : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_CHERRYS_ON_BOTTOM)
            ? "blink_me"
            : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_SEVENS_ANY_LINE)
            ? "blink_me"
            : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_CHERRY_AND_SEVEN)
            ? "blink_me"
            : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_3XBAR_LINE) ? "blink_me" : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_2XBAR_LINE) ? "blink_me" : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_BAR_LINE) ? "blink_me" : ""
        }
      >
      ...
      <ListItem
        button
        className={
          isWinningPayTableLine(WINNING_PAY_TABLE_COMBINAION_BAR_LINE)
            ? "blink_me"
            : ""
        }
      >
